...
In the main analysis in @sec-analyze we focused on contrasting the mood at the beginning of a session with the average mood during session. In this document we focus on two additional research questions:
