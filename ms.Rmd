...
The data and code we used to analyze it are available on GitHub (<https://github.com/digital-wellbeing/pws-prepost>) and archived at Zenodo (<https://zenodo.org/doi/10.5281/zenodo.10021014>). For the full PWS dataset, see @vuorreIntensiveLongitudinalDataset2023.
