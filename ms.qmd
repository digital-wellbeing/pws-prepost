---
abstract: "***Abstract*** Although video games receive immense attention as potential carriers of both positive and negative psychological effects, empirical evidence on games' effects remains mixed. One reason for this, we believe, is that the effects of games---if any---might be short lived and transient. To capture potential effects of games during play itself, we queried XXX players mood at the start of XXX gameplay sessions and in XXX subsequent moods. Critically, mood was reported in game in a modified version of a commercially available game. We found X Y and Z but surprisingly not XYZ. Implications. Statements."
date: 2023-07-18
...
Here, we ask how players' mood changes during gameplay sessions. 
